...
basic.forever(function () {
    ...
    if (ps2controller.button_pressed(ps2controller.PS2Button.Up) == 1) {
        ...
        music.play(music.stringPlayable("E D C D E E E E ", 120), music.PlaybackMode.InBackground)
        music.play(music.stringPlayable("D D D D E E E E ", 120), music.PlaybackMode.InBackground)
        music.play(music.stringPlayable("E D C D E E E E ", 120), music.PlaybackMode.InBackground)
        music.play(music.stringPlayable("D D E D C C C C ", 120), music.PlaybackMode.InBackground)
